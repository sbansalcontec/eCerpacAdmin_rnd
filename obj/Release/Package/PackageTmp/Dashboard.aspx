...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        // Ensure the 'min' for 'byDateToAS' is always the date selected in 'byDateFromAS'
        //dateFromAS.addEventListener('input', function () {
        //    const selectedFromDate = dateFromAS.value;
        //    dateToAS.setAttribute('min', selectedFromDate);
        //});
        dateFromAS.addEventListener('input', function () {
            ...
            if (selectedFromDate <= today) {
                dateToAS.setAttribute('max', formattedToday);
                dateToAS.setAttribute('min', formattedToday);// Restrict 'to' date to today
            } else {
