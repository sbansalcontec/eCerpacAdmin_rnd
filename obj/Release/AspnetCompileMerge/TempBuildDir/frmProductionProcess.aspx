...
<span id="charCount">Characters remaining: 70</span>
                    ...
                    <div style="text-align: center;">
                        ...
                        <asp:Button ID="btnReferred" class="generate-id-heading green-background" runat="server" ValidationGroup="a2" Text="Refer to Comptroller General " OnClick="btnReferred_Click" />
                        <asp:Button ID="btnCorrection" class="generate-id-heading green-background" runat="server" ValidationGroup="a2" Text="Correction" OnClick="btnCorrection_Click" />
                    </div>
                </div>
