            ...
            <div id="DivPersonalDetails" runat="server" align="left" class="bcolour" style="text-align: center; border: 1px solid Gray; padding: 10px; border-radius: 10px; display: block; margin-bottom: 10px">
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left" class="b55">Sex : </td>
                        <td align="left">
         ...
         <asp:Label ID="lblMaritalStatus" runat="server" CssClass="b99"></asp:Label></td>
            ...
            <div id="Div1" runat="server" align="left" class="bcolour" style="border: 1px solid Gray; padding: 10px; border-radius: 10px; display: block; margin-bottom: 10px">
                ...
                <div class="writeComment">
                    <div class="cleft">
                        <asp:DropDownList class="emov-dash-icon-cover1" Width="100%" ID="commentList" Style="margin-right: 5px; background-color: #f8f8f8; padding: 5px 5px 5px 15px; border: 1px solid #f8f8f8;" runat="server">
                            ...
                            <asp:ListItem Text="Refer to Comptroller" Value="N" />
                        </asp:DropDownList>
                    </div>
                    <div class="cright">
                ...
                <div style="text-align: center;">
                    ...
                    <asp:Button ID="btnApproved" class="generate-id-heading green-background" runat="server" ValidationGroup="a2" Text="Approved" OnClientClick="return ConvertToImage(this)" OnClick="btnApproved_Click" />
                    <asp:Button ID="btnReferBack" class="generate-id-heading green-background" runat="server" ValidationGroup="a2" Text="Refer to Comptroller" OnClick="btnReferBack_Click" />
                    <asp:Button ID="btnReject" class="generate-id-heading green-background" runat="server" ValidationGroup="a2" Text="Reject " OnClick="btnReject_Click" />
                </div>
            </div>
