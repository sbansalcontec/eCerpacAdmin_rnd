<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.Master" AutoEventWireup="true" EnableEventValidation="false" Async="true" CodeBehind="frmNISCGApproval.aspx.cs" Inherits="eCerpac_NIS.frmNISCGApproval" %>
...
<!-- Include jQuery UI (Must be included after jQuery) -->
    ...
    <asp:UpdatePanel ID="updAll" runat="server" UpdateMode="Conditional">
                            ...
                            <td colspan="3" style="height: 5px">
                                <div class="PageNameHeadingCSS" style="text-align: center">
                                    <font class="b12">
                                        ...
                                        <div class="generate-id-heading green-background">Comptroller General Queue</div>
                                    ...
                                    <table class="t11" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" style="height: 16px;" colspan="3">
                                                ...
                                                <asp:GridView ID="GridViewCG" PagerStyle-CssClass="pgr"
                                                    ...
                                                    OnPageIndexChanging="GridViewCG_PageIndexChanging" OnRowDataBound="GridViewCG_RowDataBound" OnRowCommand="GridViewCG_RowCommand" OnSelectedIndexChanged="GridViewCG_SelectedIndexChanged">
                                                    <Columns>
      ...
      <ItemTemplate>
        ...
        <tr>
                ...
                <asp:Label ID="lblCerpacNo1" runat="server" CssClass="b99"></asp:Label>
                    ...
                    <div id="Div1" runat="server" align="left" class="bcolour" style="border: 1px solid Gray; padding: 10px; border-radius: 10px; display: block; margin-bottom: 10px">
                            ...
                            <table id="tbl_comments" runat="server" class="cttable lcomment" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr style="display: none;">
                                        <td>L3</td>
                                        <td>
                                            <asp:Label ID="lblNameL3" runat="server" CssClass="b99"></asp:Label></td>
                                        <td>
                                            <asp:Label ID="lblCommetL3" runat="server" CssClass="b99"></asp:Label></td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="writeComment">
                            <div class="cleft">
                                <asp:DropDownList class="emov-dash-icon-cover1" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="commentList_SelectedIndexChanged" ID="commentList" Style="margin-right: 5px; background-color: #f8f8f8; padding: 5px 5px 5px 15px; border: 1px solid #f8f8f8;" runat="server">
                                    <%--<asp:ListItem Text="Select" Value="" />--%>
                                    <asp:ListItem Text="Application Granted" Value="A" />
                                    <asp:ListItem Text="Application Rejected" Value="N" />
                                    <asp:ListItem Text="Refer to Comptroller" Value="M" />
                                </asp:DropDownList>
                            </div>
                            <div class="cright">
                                <textarea placeholder="Please Enter Your Comments..." id="Textarea1" maxlength="70" validationgroup="a2" runat="server" onkeyup="updateCharCount()" onkeydown="updateCharCount()" onpaste="updateCharCount()" oninput="updateCharCount()"></textarea>
                        ...
                        <div style="text-align: center;">
                            ...
                            <asp:Button ID="btnReferBack" Enabled="false" class="generate-id-heading green-background" runat="server" ValidationGroup="a2" Text="Refer to Comptroller" OnClick="btnReferBack_Click" />
                            <asp:Button ID="btnReject" Enabled="false" class="generate-id-heading green-background" runat="server" ValidationGroup="a2" Text="Reject " OnClick="btnReject_Click" />
                        </div>
                    </div>
                </div>
            </asp:Panel>
            ...
            <asp:Panel ID="pnlRejection" runat="server" Style="display: none;">

                <center>
                    <div align="center" class="confirmation-box" height="10px" style="margin-top: 30px;">
                        <p style="color: #006600" runat="server"><strong>Application has been rejected.</strong></p>
                    </div>
                </center>
            </asp:Panel>

            <asp:Panel ID="pnlReferBack" runat="server" Style="display: none;">

                <center>
                    <div align="center" class="confirmation-box" height="10px" style="margin-top: 30px;">
                        <p style="color: #006600" runat="server"><strong>Application has been refered to L3 officer.</strong></p>
                    </div>
                </center>
            </asp:Panel>
